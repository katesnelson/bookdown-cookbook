...
\hypersetup{
  pdftitle={A Literal Cookbook made using R Bookdown},
...
\title{A Literal Cookbook made using R Bookdown}
\author{Kate Nelson}
\date{2020-10-26}
...
\hypertarget{my-r-inspired-kitchen}{%
\chapter{My R Inspired Kitchen}\label{my-r-inspired-kitchen}}
